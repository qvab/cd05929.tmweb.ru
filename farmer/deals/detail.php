...
?>
    <?$APPLICATION->IncludeComponent("rarus:farmer.deal.mark", "",
        Array(
...
elseif ($_REQUEST['page'] == 'docs') {
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "SORT_ORDER1" => "ASC",
            "SORT_ORDER2" => "ASC",
            "LIST_URL" => "/farmer/deals/",
            "SELF_URL" => "/farmer/deals/".$_REQUEST['ELEMENT_ID']."/",
            "LOGS" => $logs,
