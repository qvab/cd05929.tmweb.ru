...
/*
 * добавить свойства, соответствующие дополнительным опциям. Опции, и описания к ним, даны в файле "Дополнительные сервисы 2019 08 20"
 *
 * В ИБ "Сделки"->"Сделки"
 */
...
$arIBlocks = array(
    array(
        ...
        'PROPERTIES' => array( // Массив свойст ИБ
            'IS_ADD_CERT' => array(
                'NAME'			=> 'Сертифицированный отбор проб и лабораторная диагностика',
                'SORT'          => '4800',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'S',
            ),
            'IS_BILL_OF_HEALTH' => array(
                'NAME'			=> 'Карантинное свидетельство',
                'SORT'          => '4810',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'S',
            ),
            'IS_VET_CERT' => array(
                'NAME'			=> 'Ветеринарные свидетельства',
                'SORT'          => '4820',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'S',
            ),
            'IS_QUALITY_CERT' => array(
