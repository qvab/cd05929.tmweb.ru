<?php
/**
 * Создание HL блока с лучшими ценами
 */
...
$arHighBlocks = array(
    array(
        // Имя таблицы
        'TABLE_NAME' => 'best_prices',
        // Название сущности
        'ENTITY_NAME' => 'BESTPRICES',
        // Языкозависимые названия
        'LANGS' => array('ru' => 'Лучшие цены',),
        ...
        'OPTIONS_HIGHLOADBLOCK' => array(
            'FIELDS'=> array(
                'UF_DATE' => array(
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'Дата',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Дата',),
                    'SETTINGS' => array(
                ...
                'UF_OFFER_ID' => array(
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'ID товара',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'ID товара',),
                ),
                'UF_CULTURE_ID' => array(
                    'SORT'              => $iSort += 10,
                    'MANDATORY'         => 'N',
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'ID культуры',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'ID культуры',),
                ),
                'UF_REGION_ID' => array(
                    'SORT'              => $iSort += 10,
                    'MANDATORY'         => 'N',
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'ID региона',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'ID региона',),
                ),
                'UF_REGION_LINK' => array(
                    'SORT'              => $iSort += 10,
                    'MANDATORY'         => 'N',
                    'USER_TYPE_ID'      => 'integer',
                    'MULTIPLE'          => 'N',
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'Флаг - смежный регион',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Флаг - смежный регион',),
                ),
                'UF_PRICE' => array(
                    'SORT'              => $iSort += 10,
                    'MANDATORY'         => 'N',
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'Цена',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Цена',),
                ),
            ),
        ),
    ),
