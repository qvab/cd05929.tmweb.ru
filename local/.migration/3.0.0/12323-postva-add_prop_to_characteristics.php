...
/*
 * 1. Добавляет свойство "Сброс ниже базисного значения"
 * 2. Добавляет свойство "Сброс выше базисного значения"
 * 3. Заполняем из файла
 *
 * В ИБ "Справочники"->"Характеристики"
 */
...
$arIBlocks = array(
    array(
        ...
        'PROPERTIES' => array( // Массив свойст ИБ
            'RESET_BELOW_BASIS' => array(
                'NAME'			=> 'Сброс, ниже базисного значения',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'HINT'			=> '',
                'MULTIPLE'      => 'N',
            ...
            'RESET_MORE_BASIS' => array(
                'NAME'			=> 'Сброс, выше базисного значения',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'HINT'			=> '',
                'MULTIPLE'      => 'N',
...
try {
    ...
    /**
     * ==================================================================
     * Заполняем значения сброса базиса для культур по значениям из файла к задаче #12323
     * ==================================================================
     */
     ...
     * Общие
     */
    culture::setResetToCharByQuality('Влажность', '', 0, -1, true );
    culture::setResetToCharByQuality('Сорная примесь', '', 0, -1, true );

    /**
     * Зерновые
     */
    culture::setResetToCharByQuality('Зерновая примесь', '', 0, -1, true );

    /**
     * масляничные
     */
    culture::setResetToCharByQuality('Масличность а.с.в.', '', -1, 1, true );
    culture::setResetToCharByQuality('Кислотное число (КЧМ)', '', 0, -1, true );
