<?php
/**
 * Добавляет HL "Мои цены" для хранения данных запросов покупателей (для построения графика) - Хранилище
...
$arHighBlocks = array(
    array(
        // Имя таблицы
        'TABLE_NAME' => 'rrs_count_req_my_prices',
        // Название сущности
        'ENTITY_NAME' => 'CONTREQMYPRICES',
        // Языкозависимые названия
        'LANGS' => array('ru' => 'Мои цены (для построения графиков для предложений)',),
        ...
        'OPTIONS_HIGHLOADBLOCK' => array(
            'FIELDS'=> array(
                ...
                'UF_USER_ID' => array(
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'ID пользователя',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'ID пользователя',),
                ),
                'UF_WAREHOUSE' => array(
                    'SORT'              => $iSort += 10,
                    'MANDATORY'         => 'N',
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'Склад',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Склад',),
                ),
                'UF_CULTURE' => array(
                    'SORT'              => $iSort += 10,
                    'MANDATORY'         => 'N',
                ...
                'UF_PRICE' => array(
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'Цена (св-во PRICE)',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Цена (св-во PRICE)',),
                ),
                'UF_REQUEST' => array(
                    'SORT'              => $iSort += 10,
                    'MANDATORY'         => 'N',
                    ...
                    'EDIT_IN_LIST'      => 'Y',
                    'IS_SEARCHABLE'     => 'N',
                    'EDIT_FORM_LABEL'   => array('ru' => 'ID запроса',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'ID запроса',),
                ),
            ),
        ),
    ),
