<?php
/*
 * Добавляет свойства "Процент вознаграждения"
 */
...
$arIBlocks = array(
    array(
        ...
        'PROPERTIES' => array( // Массив свойст ИБ
            'REWARD_PERCENT' => array(
                'NAME'			=> 'Процент вознаграждения',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'HINT'			=> 'Процент вознаграждения агента, задает значение "Организатор"',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
                'SORT'          => 600,
            ),
            'PERCENT_TRANSPORTATION' => array(
                'NAME'			=> 'Процент вознаграждения за транспортировку',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'HINT'			=> 'Процент вознаграждения агента, задает значение "Организатор"',
                'MULTIPLE'      => 'N',
    ...
    array(
        ...
        'PROPERTIES' => array( // Массив свойст ИБ
            ...
            'AGENT_CLIENT_USER' => array(
                'NAME'			=> 'Агент покупателя',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'S',
                'USER_TYPE'     => 'UserID',
                'MULTIPLE'      => 'N',
            ...
            'REWARD_PERCENT_AGENT' => array(
                'NAME'			=> 'Процент вознаграждения агента поставщика',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
            ...
            'REWARD_PERCENT_AGENT_CLIENT' => array(
                'NAME'			=> 'Процент вознаграждения агента покупателя',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
            ...
            'REWARD_PERCENT_OPERATOR_AH' => array(
                'NAME'			=> 'Процент вознаграждения оператора АХ от организатора АП',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
            ...
            'REWARD_PERCENT_ORGANIZER' => array(
                'NAME'			=> 'Процент вознаграждения организатору покупателя от вознаграждения организатора АП (если они разные)',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
            ...
            // Проценты вознаграждения за транспортировку
            'REWARD_PERCENT_TRANSPORTATION_AGENT' => array(
                'NAME'			=> 'Процент вознаграждения за транспортировку агента поставщика',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
            ...
            'REWARD_PERCENT_TRANSPORTATION_OPERATOR_AH' => array(
                'NAME'			=> 'Процент вознаграждения за транспортировк оператору АХ от вознаграждения организатора АП',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
