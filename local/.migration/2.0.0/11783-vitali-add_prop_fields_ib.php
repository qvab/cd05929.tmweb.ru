...
/*
 * Добавляет свойство "Кол-во АП с лучшей ценой"
 */
...
$arIBlocks = array(
    ...
    array(
        ...
        'PROPERTIES' => array( // Массив свойст ИБ
            'FARMER_BEST_PRICE_CNT' => array(
                'NAME'			=> 'Кол-во АП с лучшей ценой',
                'ACTIVE' 		=> 'Y',
                'PROPERTY_TYPE' => 'N',
                'HINT'			=> 'Количество АП, для которых запрос покупателя стал лучшим по цене (в разрезе культуры)',
                'MULTIPLE'      => 'N',
                'IS_REQUIRED'   => 'N',
                'SORT'          => 1500,
            ),
