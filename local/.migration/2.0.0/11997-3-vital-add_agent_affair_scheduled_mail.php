<?php
/*
 *  Добавляет агент для отправки email оповещения о наступлении даты запланированного "Дела"
 */
...
$arAgents = [
    [
        'NAME'          => 'CAffair::AgentSendMailScheduled();',
        'MODULE_ID'     => '',
        'PERIOD'        => 'Y',
        'INTERVAL'      => 60*60*24,
        'DATE_CHECK'    => null,
        'ACTIVE'        => 'Y',
        'NEXT_EXEC'     => date('d.m.Y') . ' 09:00:00',
        'SORT'          => 10,
    ],
];
