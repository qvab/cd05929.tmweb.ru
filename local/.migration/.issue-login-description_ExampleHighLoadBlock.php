<?php
/**
 * Пример создания HighLoadBlock скриптом миграции
 * Скрипт несовершенный, разумные допилы приветствуются
 *
...
$arHighBlocks = array(
    array(
        // Имя таблицы
        'TABLE_NAME' => 'b_hl_example_table',
        // Название сущности
        'ENTITY_NAME' => 'EntityName',
        // Языкозависимые названия
        'LANGS' => array('ru' => 'Тестовый HL',),
        ...
        'OPTIONS_HIGHLOADBLOCK' => array(
            'FIELDS' => array(
                'UF_KEY' => array(
                    ...
                    'EDIT_IN_LIST' => 'Y',
                    'IS_SEARCHABLE' => 'N',
                    'EDIT_FORM_LABEL' => array('ru' => 'Уникальный ключ',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Уникальный ключ',),
                ...
                'UF_ACTIVE' => array(
                    ...
                    'EDIT_IN_LIST' => 'Y',
                    'IS_SEARCHABLE' => 'N',
                    'EDIT_FORM_LABEL' => array('ru' => 'Активность',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Активность',),
                ),
                'UF_NAME' => array(
                    'SORT' => $iSort += 10,
                    'MANDATORY' => 'Y',
                    ...
                    'EDIT_IN_LIST' => 'Y',
                    'IS_SEARCHABLE' => 'N',
                    'EDIT_FORM_LABEL' => array('ru' => 'Название',),
                ...
                'UF_IMAGE' => array(
                    ...
                    'EDIT_FORM_LABEL' => array('ru' => 'Изображение',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Изображение',),
                ),
                'UF_CODE' => array(
                    'SORT' => $iSort += 10,
                    'MANDATORY' => 'Y',
                ...
                'UF_XML_ID' => array(
                    ...
                    'EDIT_IN_LIST' => 'Y',
                    'IS_SEARCHABLE' => 'N',
                    'EDIT_FORM_LABEL' => array('ru' => 'Внешний код',),
                    'LIST_COLUMN_LABEL' => array('ru' => 'Внешний код',),
                ),
                'UF_SORT' => array(
                    'SORT' => $iSort += 10,
                    'MANDATORY' => 'Y',
