...
<div class="tab_form">
    ...
    if (in_array('yes', $arParams['STATUS_LIST'])) {
        ...
        <? } else { ?>
            <div class="item"><a href="<?=$arParams['LIST_URL']?>?uid=<?=$arParams['U_ID']?>">Активные (<?=$arResult['Q']['yes']?>)</a></div>
        <? }
    }
    ...
    if (in_array('no', $arParams['STATUS_LIST'])) {
        ...
        <? } else { ?>
            <div class="item"><a href="<?=$arParams['LIST_URL']?>?uid=<?=$arParams['U_ID']?>&status=no">Неактивные (<?=$arResult['Q']['no']?>)</a></div>
        <? }
    }
    ...
    if (in_array('all', $arParams['STATUS_LIST'])) {
        ...
        <? } else { ?>
            <div class="item last"><a href="<?=$arParams['LIST_URL']?>?uid=<?=$arParams['U_ID']?>&status=all">Все (<?=$arResult['Q']['all']?>)</a></div>
        <? }
    }
    ?>
    <div class="clear"></div>
...
$GLOBALS[$filterName]['PROPERTY_FARMER'] = $arParams['U_ID'];
