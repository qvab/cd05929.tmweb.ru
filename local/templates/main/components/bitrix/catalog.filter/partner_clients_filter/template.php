...
$checkFilter = partner::filterPartnerClientsCheck();
...
<div class="tab_form">
    <form method="GET" class="client_select">

        <div class="row">
            <?$sDataSearch = (count($arResult['ITEMS']) > 4) ? 'data-search="y"' : null;?>
            <div class="wrap-select">

                <select <?=$sDataSearch?> name="client_id">
        ...
        <div class="row">
            <div class="wrap-select">
                <select name="is_linked">
                    ...
                    <option value="1" <?=($active_link_type == 1 ? 'selected="selected"' : '');?>>Привязанные покупатели</option>
                    <option value="2" <?=($active_link_type == 2 ? 'selected="selected"' : '');?>>Не привязанные покупатели</option>
                </select>
            </div>
        </div>
