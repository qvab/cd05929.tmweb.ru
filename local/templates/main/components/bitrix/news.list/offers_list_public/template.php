...
if (sizeof($arResult["ITEMS"]) > 0) {
    ...
    <div class="additional_href_data">
        <a href="/partner/offer/new/?farmer_id=<?=$arParams['U_ID']?>&back_url=<?=$APPLICATION->GetCurPageParam()?>">+ Добавить товар</a>
    </div>
                ...
                <form action="" method="post" class="line_additional">
                    ...
                    if ($arItem['PROPERTIES']['WAREHOUSE']['VALUE']
                        ...
                        <div class="prop_area adress_val wh_addr">
                            ...
                            <div class="val_adress" data-regionname="<?=$arResult['WAREHOUSES_LIST'][$arItem['PROPERTIES']['WAREHOUSE']['VALUE']]['REGION_NAME'];?>"><?=$arResult['WAREHOUSES_LIST'][$arItem['PROPERTIES']['WAREHOUSE']['VALUE']]['ADDRESS']?></div>
                        </div>
                        <?
                    }
                    ?>
...
?>
<a href="/partner/offer/new/?farmer_id=<?=$arParams['U_ID']?>&back_url=<?=$APPLICATION->GetCurPageParam()?>" class="add_blue_button">Добавить товар<div class="but_addit"><div class="ico">+</div></div></a>
