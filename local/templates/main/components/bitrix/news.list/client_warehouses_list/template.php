...
if (sizeof($arResult["ITEMS"]) > 0) {
    ...
    if (count($arResult["ITEMS"]) > 10):?>
        <div class="additional_href_data">
            <a href="/client/warehouses/add/">+ Добавить склад</a>
        </div>
    <?endif;?>
...
?>
<a href="/client/warehouses/add/" class="add_blue_button warehouses">Добавить склад<div class="but_addit"><div class="ico">+</div></div></a>
