...
<div class="content-form become_agrohelper_page <?/*public_form*/?>" data-actionobj="become_agrohelper">
    <?
    /**?>
     * Уходим от JS задача 12020, сохранил старье на всякий случай
     */?>
    <!--<div class="close" onclick="closePublicForm(this);"></div>-->

    <form class="become_form" action="" method="post" enctype="multipart/form-data">

        <input type="hidden" name="PUBLIC_FORM" value="BECOME">
        ...
        <div id="recaptcha_become" class="g-recaptcha" data-callback="onRecSubmit" data-size="invisible"></div>
