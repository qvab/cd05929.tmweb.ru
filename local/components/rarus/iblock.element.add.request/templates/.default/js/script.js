$(document).ready(function() {
    ...
    $('#request_tarrifs').on('click',function(){
        ...
        var csort = $('.request-block-intro input[name="csort"]:checked').val();
        window.open('/client/request/tariffs/index.php?'+'remoteness='+remoteness+'&csort='+csort, '_blank');

        /*var remoteness = $('input[name="remoteness"]');

        $.ajax({
            type: "POST",
            url: '/client/request/tariffs/index.php',
            data: 'remoteness='+remoteness+'&uid='+uid,
            dataType: "JSON",
