...
function uploadInnAdd(argObj){
    ...
    if(wObj.length == 1){
        ...
        if(temp_val.length != 10
            ...
            var sUserType = 'farmer';
            if($('input[type="hidden"][name="add_client"]').length === 1){
                sUserType = 'client';
            }
