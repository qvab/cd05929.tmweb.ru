        ...
        <form action="" method="get" name="agent_select">
            <div class="list_page_rows agents_list">
                <select name="agent_id" <?if(count($arResult['AGENTS']) > 4){?>data-search="y"<?}?> >
                    <option value="0">По всем пользователям</option>
                    <option value="1" <?if(isset($arParams['AGENT_ID']) && $arParams['AGENT_ID'] == 1){?>selected="selected"<?}?> >По всем агентам</option>
            ...
            <div class="row fbtn_cancel">
                <a href="/partner/dashboard/" class="cancel_filter">Сбросить</a>
            </div>
            <div class="clear"></div>
        </form>
    <?}?>
