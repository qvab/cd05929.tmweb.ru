...
<form name="iblock_add" class="request_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
    ...
    <div class="fblock_fm row">
        <div class="row_val">
            <select <?if(count($arResult['CLIENTS_DATA']) > 3){?>data-search="y"<?}?> name="client_id" placeholder="Выберите покупателя">
    ...
    <div class="request-block10 row">
        <div class="request-block-intro">
            <div class="step-title row_head">6. Подтвердите согласие с условиями работы площадки</div>
            <div class="radio_group">
                <div class="radio_area">
