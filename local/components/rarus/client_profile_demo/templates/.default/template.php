            ...
            <div class="content-form profile-form">
                <div class="fields">
                    <?if(isset($arParams['BY_AGENT']) && $arParams['BY_AGENT'] == 'Y'){?>
                        <div class="row">
                            <div class="holder row_sub_head">Данные клиента:</div>
                        </div>
                    <?}else{?>
                        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="holder row_val">
                            <input type="text" name="EMAIL" data-checkval="y" data-checktype="email" data-stabval="<?=(checkEmailFromPhone($arResult['SHOW_FIELDS']['EMAIL']) ? '' : $arResult['SHOW_FIELDS']['EMAIL']);?>" value="<?=(checkEmailFromPhone($arResult['SHOW_FIELDS']['EMAIL']) ? '' : $arResult['SHOW_FIELDS']['EMAIL']);?>" placeholder="<?=GetMessage("AUTH_EMAIL")?>">
                        </div>
                    </div>
                    ...
                    <div class="row" <? if ($arResult['SHOW_PROPS']['UL_TYPE'] == $arResult['UL_TYPES_LIST']['ip']['ID']) { ?>style="display: none;"<? } ?>>
                        ...
                        <div class="holder row_val">
                            <input type="hidden" name="PROP__FULL_COMPANY_NAME" value="<?=$arResult['SHOW_PROPS']['FULL_COMPANY_NAME']?>" />
                    ...
                    <div class="row" <? if ($arResult['SHOW_PROPS']['UL_TYPE'] == $arResult['UL_TYPES_LIST']['ip']['ID']) { ?>style="display: none;"<? } ?>>
                        ...
                        <div class="holder row_val">
                            ...
                            <input type="text" title="Заполняется автоматически после валидации ИНН" name=""  value="<?=$arResult['SHOW_PROPS']['KPP']?>" placeholder="<?=$arResult['SHOW_PROPS_TYPE']['KPP']['NAME']?>" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="holder row_val">
                            ...
                            <input type="text" title="Заполняется автоматически после валидации ИНН" name="" class="disabled" readonly="readonly" value="<?=$arResult['SHOW_PROPS']['OGRN']?>" placeholder="<?=$arResult['SHOW_PROPS_TYPE']['OGRN']['NAME']?>" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="holder row_val">
                            ...
                            <input type="text" title="Заполняется автоматически после валидации ИНН" name="" class="disabled" readonly="readonly" value="<?=$arResult['SHOW_PROPS']['OKPO']?>" placeholder="<?=$arResult['SHOW_PROPS_TYPE']['OKPO']['NAME']?>" />
                        </div>
                    </div>
