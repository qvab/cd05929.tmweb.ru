    ...
    ?>
        <form class="add_form" action="" method="POST">
            ...
            <div class="form_area">
                ...
                <div class="line row">
                    <div class="row_val one_line">
                        <input placeholder="Email" data-checkval="y" data-checktype="email" type="text" name="email" value="<?=(!isset($arResult['success_text'][0]) && isset($_POST['email']) ? trim($_POST['email']) . '" data-stabval="' . trim($_POST['email']) : '');?>" />
                    </div>
                </div>
