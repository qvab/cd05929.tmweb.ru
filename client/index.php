...
LocalRedirect('/client/exclusive_offers/');
?>
<?$APPLICATION->SetTitle("Личный кабинет покупателя");?>
    <div id="public_content" class="main_page_area public_form active">
    <div class="block_area welcome_area">
        ...
        <div class="block_data">
            ...
            <a href="/upload/docs/instruction_client.pdf" download="instruction_client.pdf" >Скачать инструкцию</a>
